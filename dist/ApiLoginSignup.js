...
var ApiSignupLoginSchema_1 = require("./ApiSignupLoginSchema");
...
var ApiLoginSignup = /** @class */ (function () {
    function ApiLoginSignup() {
        ...
        this.dataRouter.post('/signup', ApiSignupLoginSchema_1.Validator.signupSchema(), ApiSignupLoginSchema_1.Validator.handleError, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.dataRouter.post('/login', ApiSignupLoginSchema_1.Validator.loginSchema(), ApiSignupLoginSchema_1.Validator.handleError, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.dataRouter.get("/login", ApiSignupLoginSchema_1.Validator.loginSchema(), ApiSignupLoginSchema_1.Validator.handleError, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
